...
import { User, Lock, Eye, EyeOff, AlertTriangle, Droplets, Briefcase } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100/50 flex items-center justify-center px-4">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/60 shadow-lg shadow-gray-200/50 w-full max-w-md p-8 relative overflow-hidden">
                ...
                <div className="absolute -left-8 -bottom-8 w-32 h-32 rounded-full bg-teal-400/5 blur-3xl" />
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-0.5">Operator Portal</p>
                        </div>
                    </div>
                    ...
                    <p className="text-sm text-gray-500 mb-7 pl-9">Sign in to your operator account</p>
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-200/60">
                        <p className="text-sm text-center text-gray-500">
                            <Link to="/forgot-password" className="text-emerald-600 font-semibold hover:text-emerald-700 transition">
                                Forgot password?
                            </Link>
                        </p>
                    </div>
