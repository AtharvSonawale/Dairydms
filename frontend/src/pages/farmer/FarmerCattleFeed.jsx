            ...
            <main className="max-w-screen mx-auto px-4 sm:px-6 py-6 flex flex-col gap-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/60 shadow-lg shadow-gray-200/50 px-5 py-4">
                    <div>
                        <div className="flex items-center gap-2.5 text-sm text-gray-600 mb-1">
                            ...
                            <span>{t('nav.MyCattleFeed', { defaultValue: 'My Cattle Feed' })}</span>
                            <span className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-gradient-to-br from-amber-500 to-amber-600 text-white text-xs font-semibold shadow-md shadow-amber-500/30">
                                <Wheat size={12} /> {t('status.farmer', { defaultValue: 'Farmer' })}
                            </span>
                        </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        ...
                        />
                        <StatCard
                            label={t('dashboard.feedTypes', { defaultValue: 'Feed Types' })}
                            value={uniqueFeeds}
                            icon={<Package size={16} />}
                            color="blue"
                        />
                ...
                <div className="relative overflow-hidden rounded-2xl border border-amber-200/60 bg-amber-50/80 backdrop-blur-sm shadow-lg shadow-amber-200/50 px-5 py-4">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 relative z-10">
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center shadow-lg shadow-amber-500/30 shrink-0">
                ...
                <div className="relative overflow-hidden rounded-2xl border border-gray-200/60 bg-white/80 backdrop-blur-sm shadow-lg shadow-gray-200/50 p-5">
                    ...
                    <div className="relative z-10">
                        ...
                        {loading ? (
                            ...
                            <EmptyState icon={<Wheat size={32} />} msg={t('dashboard.noCattleFeed', { defaultValue: 'No cattle feed purchases for this period' })} />
                        ) : (
                            <div className="overflow-x-auto -mx-1">
                                <div className="max-h-[520px] overflow-y-auto">
                                    <table className="w-full text-sm min-w-max">
                                        <thead className="sticky top-0 z-10 bg-white/80 backdrop-blur-sm shadow-sm">
                                            <tr className="border-b border-gray-200/60 bg-gradient-to-r from-amber-50/50 to-white/50">
                                        ...
                                        <tbody className="divide-y divide-gray-100/60">
                                            {paginated.map((e) => (
                                                <tr key={e.sale_id} className="hover:bg-amber-50/20 transition">
                                                    ...
                                                    <td className="px-4 py-2.5 text-xs font-semibold text-gray-800 whitespace-nowrap border-r border-gray-200/60">{e.feed_name}</td>
                                                    <td className="px-4 py-2.5 font-mono text-amber-600 font-semibold border-r border-gray-200/60">{parseFloat(e.quantity).toFixed(2)}</td>
