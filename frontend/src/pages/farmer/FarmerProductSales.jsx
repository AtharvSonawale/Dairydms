        ...
        <div className="min-h-screen bg-[#f5f4f0]">
            <main className="max-w-screen mx-auto px-4 sm:px-6 py-8 flex flex-col gap-5">
                ...
                <div className="flex items-center gap-2 text-xs text-gray-400 mb-1">
                    ...
                    <span className="text-gray-600 font-medium">{t('dashboard.myProductPurchases', { defaultValue: 'My Product Purchases' })}</span>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    <div className="flex flex-col gap-1 px-4 py-4 rounded-2xl border border-blue-100 bg-blue-50">
                        <p className="text-[11px] font-semibold uppercase tracking-wider text-blue-600 opacity-70">{t('dashboard.productTypes', { defaultValue: 'Products' })}</p>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
                    ...
                    {loading ? (
                        ...
                        <EmptyState icon={<ShoppingBag size={28} />} msg={t('dashboard.noProductPurchases', { defaultValue: 'No product purchases for this period' })} />
                    ) : (
                                    ...
                                    <tbody className="divide-y divide-gray-50">
                                        {paginated.map((e) => (
                                            <tr key={e.sale_id} className="hover:bg-gray-50 transition">
                                                ...
                                                <td className="px-4 py-2.5 text-xs font-semibold text-gray-800 whitespace-nowrap">{e.product_name}</td>
