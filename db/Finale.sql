CREATE DATABASE IF NOT EXISTS dairy_db1;
USE dairy_db1;
...
) ENGINE=InnoDB AUTO_INCREMENT=76349 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=11033 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=66079 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=2910 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE cattle_feed_batches (
  ...
  UNIQUE KEY uq_feed_batchno (feed_id,batch_no),
  KEY idx_feed_id (feed_id),
  KEY idx_centre_id (centre_id),
  KEY idx_purchase_id (purchase_id),
  CONSTRAINT cfb_centre_fk FOREIGN KEY (centre_id) REFERENCES centres (centre_id) ON DELETE CASCADE,
  CONSTRAINT cfb_feed_fk FOREIGN KEY (feed_id) REFERENCES cattle_feeds (feed_id) ON DELETE CASCADE,
  CONSTRAINT cfb_purchase_fk FOREIGN KEY (purchase_id) REFERENCES cattle_feed_purchases (purchase_id) ON DELETE SET NULL
...
CREATE TABLE cattle_feed_buyer_settings (
  ...
  qr_printing_enabled tinyint(1) NOT NULL DEFAULT '1',
  ...
  KEY idx_centre_id (centre_id),
  KEY cfbs_operator_fk (updated_by_operator_id),
  KEY cfbs_admin_fk (updated_by_admin_id),
  CONSTRAINT cfbs_admin_fk FOREIGN KEY (updated_by_admin_id) REFERENCES admins (admin_id) ON DELETE SET NULL,
  CONSTRAINT cfbs_centre_fk FOREIGN KEY (centre_id) REFERENCES centres (centre_id) ON DELETE CASCADE,
  CONSTRAINT cfbs_operator_fk FOREIGN KEY (updated_by_operator_id) REFERENCES operators (operator_id) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE cattle_feed_sales (
  ...
  CONSTRAINT cfs_batch_fk FOREIGN KEY (batch_id) REFERENCES cattle_feed_batches (batch_id) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=4532 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE product_batches (
  ...
  created_at datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (batch_id),
  UNIQUE KEY uq_product_batchno (product_id,batch_no),
  KEY idx_product_id (product_id),
  KEY idx_centre_id (centre_id),
  KEY idx_purchase_id (purchase_id),
  CONSTRAINT pb_centre_fk FOREIGN KEY (centre_id) REFERENCES centres (centre_id) ON DELETE CASCADE,
  CONSTRAINT pb_product_fk FOREIGN KEY (product_id) REFERENCES products (product_id) ON DELETE CASCADE,
  CONSTRAINT pb_purchase_fk FOREIGN KEY (purchase_id) REFERENCES product_purchases (purchase_id) ON DELETE SET NULL
...
CREATE TABLE product_buyer_settings (
  ...
  UNIQUE KEY uq_centre (centre_id),
  KEY idx_centre_id (centre_id),
  KEY pbs_operator_fk (updated_by_operator_id),
  KEY pbs_admin_fk (updated_by_admin_id),
  CONSTRAINT pbs_admin_fk FOREIGN KEY (updated_by_admin_id) REFERENCES admins (admin_id) ON DELETE SET NULL,
  CONSTRAINT pbs_centre_fk FOREIGN KEY (centre_id) REFERENCES centres (centre_id) ON DELETE CASCADE,
  CONSTRAINT pbs_operator_fk FOREIGN KEY (updated_by_operator_id) REFERENCES operators (operator_id) ON DELETE SET NULL
...
CREATE TABLE product_sales (
  ...
  CONSTRAINT product_sales_ibfk_buyer FOREIGN KEY (buyer_id) REFERENCES product_named_buyers (buyer_id) ON DELETE SET NULL,
  CONSTRAINT ps_batch_fk FOREIGN KEY (batch_id) REFERENCES product_batches (batch_id) ON DELETE SET NULL
...
CREATE TABLE stock_transfers (
  ...
  KEY st_dairy_fk (dairy_id),
  KEY st_created_by_fk (created_by),
  KEY st_created_by_admin_fk (created_by_admin_id),
  KEY st_approved_by_fk (approved_by),
  KEY st_approved_by_admin_fk (approved_by_admin_id),
...
CREATE TABLE usb_device_settings (
  id int NOT NULL AUTO_INCREMENT,
  dairy_id int NOT NULL,
  ...
  role enum('scale','analyzer','ignore','unassigned') NOT NULL DEFAULT 'unassigned',
  baud_rate varchar(20) NOT NULL DEFAULT '9600',
  data_bits varchar(5) NOT NULL DEFAULT '8',
  stop_bits varchar(5) NOT NULL DEFAULT '1',
  parity varchar(10) NOT NULL DEFAULT 'none',
  regex_pattern varchar(255) NOT NULL DEFAULT '',
  regex_group tinyint NOT NULL DEFAULT '1',
  target_page enum('gavali_milk','utpadak_milk','both','none') NOT NULL DEFAULT 'none',
  target_field enum('weight','fat','snf','none') NOT NULL DEFAULT 'none',
  kg_unit_label varchar(10) NOT NULL DEFAULT 'Kg',
  ltr_unit_label varchar(10) NOT NULL DEFAULT 'Ltr',
  default_weight_unit enum('kg','ltr') NOT NULL DEFAULT 'ltr',
  is_active tinyint(1) NOT NULL DEFAULT '1',
  ...
  created_at timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  UNIQUE KEY uq_dairy_device (dairy_id,device_key),
  KEY idx_dairy (dairy_id),
  KEY idx_role (dairy_id,role),
  CONSTRAINT usb_settings_dairy_fk FOREIGN KEY (dairy_id) REFERENCES dairies (dairy_id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE walkin_named_buyers (
  ...
  default_milk_type enum('cow','buffalo','mixed') DEFAULT 'cow',
...
CREATE TABLE walkin_buyer_settings (
  ...
  UNIQUE KEY uq_centre (centre_id),
  KEY idx_centre_id (centre_id),
  KEY wbs_operator_fk (updated_by_operator_id),
  KEY wbs_admin_fk (updated_by_admin_id),
  CONSTRAINT wbs_admin_fk FOREIGN KEY (updated_by_admin_id) REFERENCES admins (admin_id) ON DELETE SET NULL,
  CONSTRAINT wbs_centre_fk FOREIGN KEY (centre_id) REFERENCES centres (centre_id) ON DELETE CASCADE,
  CONSTRAINT wbs_operator_fk FOREIGN KEY (updated_by_operator_id) REFERENCES operators (operator_id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
